...
| 1.4 | 2026-05-30 | Agentic 接入：创建弹窗增加 Agentic 创建模式，支持 Agent Loop 自动生成资源文档内容 |
...
资源模块的创建弹窗已接入 Agentic 能力：选择"Agentic 创建"后，输入资源描述，Agent Loop 自动生成资源文档内容。模板可在 **设置 → 资源** 页面中配置。