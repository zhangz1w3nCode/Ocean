...
import { Type, Zap, Eye, Edit3, MessageSquare, PenLine, Loader2, Bot, Wand2, Brain, Sparkles } from 'lucide-react'
...
export const AbilityModal: FC<AbilityModalProps> = ({
  ...
  const handleClaudeCreate = async () => {
    ...
    try {
      ...
      console.error('[Claude Ability Create] 执行失败:', error)
    }
  }
  ...
  const handleClaudeContinue = async () => {
    ...
    try {
      ...
      console.error('[Claude Ability Continue] 执行失败:', error)
    }
  }
